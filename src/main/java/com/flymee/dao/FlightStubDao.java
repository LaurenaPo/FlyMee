...
public class FlightStubDao implements FlightDao {
	...
	public Flight createFlight() {
		Flight newFlight = new Flight(3, "TNS", "ORY", new LocalDateTime(2021, 6, 4, 17, 30),
				new LocalDateTime(2021, 6, 4, 19, 00), 4, 2, new Pilot(), new ArrayList<User>(), new Aircraft(), 81f,
				"Tunis");
	...
	public Flight updateFlight(int flightID) {
		for (Flight flight : flightList) {
			if (flight.id == flightID) {
				...
				Flight flightUpdated = new Flight(4, "TNS", "ORY", new LocalDateTime(2021, 7, 4, 17, 30),
						new LocalDateTime(2021, 7, 4, 19, 00), 4, 2, new Pilot(), new ArrayList<User>(), new Aircraft(),
						81f, "Tunis");
