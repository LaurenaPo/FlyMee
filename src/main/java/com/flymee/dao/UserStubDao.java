...
public class UserStubDao implements UserDao {
	...
	public UserStubDao() {
		...
		User test1 = new User(1, "Jean", "Dupont", "jean.dupont@gmail.com", new LocalDate(2000, 1, 1), "1234");
		User test2 = new User(2, "Marine", "Dupont", "marine.dupont@gmail.com", new LocalDate(2000, 1, 2), "1234");
		User test3 = new User(3, "Marc", "Dupont", "marc.dupont@gmail.com", new LocalDate(2000, 1, 3), "1234");
		...
		Flight flight1 = new Flight(1, "NCE", "ORY", new LocalDateTime(2021, 4, 4, 17, 30),
				new LocalDateTime(2021, 4, 4, 19, 00), 4, 2, new Pilot(), this.userList, new Aircraft(), 81f, "Nice");
		Flight flight2 = new Flight(2, "ORY", "NCE", new LocalDateTime(2021, 4, 10, 17, 30, 00),
				new LocalDateTime(2021, 4, 10, 19, 00), 4, 2, new Pilot(), this.userList, new Aircraft(), 87f,
				"Ch�telet");
	...
	public boolean createUser(String userEmail, String userPassword, boolean pilot) {
		User newUser = new User(4, "Oak", "Cacahou�te", "oak.cacahouete@gmail.com", new LocalDate(1999, 10, 17), "1234");
	...
	public User updateUser(int userID) {
		for (User user : userList) {
			if (user.getId() == userID) {
				...
				User userUpdated = new User(userID, "Kao", "Otoko", "kao.otoko@gmail.com", new LocalDate(1999, 10, 17),
						"1234");
